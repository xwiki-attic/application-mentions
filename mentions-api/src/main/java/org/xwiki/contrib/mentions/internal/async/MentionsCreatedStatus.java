...
/**
 * The mention creation job status.
 *
 * @version $Id$
 * @since 1.0
 */
public class MentionsCreatedStatus extends AbstractJobStatus<MentionsCreatedRequest>
{
    /**
     * Default constructor.
     *
     ...
     */
    public MentionsCreatedStatus(String jobType, MentionsCreatedRequest request, JobStatus parentJobStatus,

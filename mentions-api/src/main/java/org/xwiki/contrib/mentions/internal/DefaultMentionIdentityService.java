...
/**
 * Default implementation of {@link MentionIdentityService}.
 *
 * @version $Id$
 * @since 1.0
 */
@Component
@Singleton
public class DefaultMentionIdentityService implements MentionIdentityService
{
    @Inject
    private DocumentReferenceResolver<String> documentReferenceResolver;

    @Override
    public Set<String> resolveIdentity(String identifier)
    {
